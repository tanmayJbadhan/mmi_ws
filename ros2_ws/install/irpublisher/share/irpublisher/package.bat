...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\irpublisher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\irpublisher\hook\ament_prefix_path.bat"
